...
# must be created with a password and password_confirmation fields

# email unique ex. TEST@TEST.com should not be allowed if test@test.com is in db




# password minimum length: pw must have min length when user acct is being created.
